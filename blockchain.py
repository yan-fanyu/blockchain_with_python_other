from functools import reduce  # importing only reduce function (in the code we dont use functools prefix anymore
    ...
    def resolve(self):
        ...
        for node in self.__peer_nodes:
            ...
            try:
                ...
                if node_chain_lenght > local_chain_length and Verification.verify_chain(node_chain):
